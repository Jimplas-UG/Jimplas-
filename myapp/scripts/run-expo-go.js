...
if (forceTunnel) {
  ...
  if (process.platform === 'win32') {
    console.log('');
    console.log('[expo-go] If Expo Go shows "Failed to download remote update":');
    console.log('[expo-go]   1) Admin PowerShell in myapp: npm run fix:metro-firewall');
    console.log('[expo-go]   2) Wi-Fi profile = Private (not Public)');
    console.log('[expo-go]   3) USB: enable USB debugging, plug phone, run: npm run start:usb');
    console.log('[expo-go]   4) Or: EXPO_FORCE_TUNNEL=1 npm start');
  }
  console.log('');
}
